...
- **No guardian liveness check.** If all guardians lose their keys, recovery is permanently impossible with no on-chain fallback. See [§7 Guardian Liveness and Last-Resort Recovery](#7-guardian-liveness-and-last-resort-recovery) for operational guidance and recommended mitigations.
